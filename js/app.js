(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        ...
                        currentSlides.innerHTML = swiper.realIndex + 1;
                    }
                }
            });
            ...
            if (document.querySelector(".thumbs-image")) {
                const thumbsSwiper = new core(".thumbs-image ", {
...
***************************************************************************** */
        ...
        const footerArrow = document.querySelectorAll(".spoller-item-footer__title");
        footerArrow.forEach((footerItem => {
            footerItem.addEventListener("click", (function() {
                footerItem.classList.toggle("_active");
            }));
        }));
        window["FLS"] = true;
        isWebp();
